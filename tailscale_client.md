...
Tailscale is a surprisingly easy-to-use VPN that allows fine-grained control over all devices in a Tailnet (network of Tailscale devices from an organization). [Tailscale](https://tailscale.com/)
...
>Private services in a VPC are only available for Tailscale devices that possess the needed permissions. Permissions are being managed with a GitOps action; you can find it at [percy-liberty-acl-tailscale](https://github.com/gitMLS/percy-liberty-acl-tailscale)
